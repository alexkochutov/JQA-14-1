...
class ManagerTest {
    ...
    Ticket ticket4 = new Ticket(4, 10500, "VVO", "LED", 120);
    Ticket ticket5 = new Ticket(5, 12900, "VVO", "LED", 80);
    ...
    @Test
    public void shouldFindAllFewResultsSortedByDuration() {
        Repository repo = new Repository();
        Manager manager = new Manager(repo);
        ...
        repo.save(ticket6);
        repo.save(ticket3);
        Ticket[] expected = {ticket5, ticket6, ticket1, ticket7, ticket4};
        Ticket[] actual = manager.sortByDuration("VVO", "LED", comparator);
        assertArrayEquals(expected, actual);
    }
}